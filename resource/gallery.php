...
<p> </p>
            ...
            <h3><br /><span style="color:#003a70;"><?=$row['title']?></span></h3>
            <hr />
            ...
            <a   class="pic" href="<?=GALLERY.$row1['image']?>" title="Is It Worth Going to Medical School?" aria-label="Is It Worth Going to Medical School?" data-gtm=&#039;call-to-action&#039;>
            ...
            <img src="<?=GALLERY.$row1['image']?>" typeof="foaf:Image" class="image-style-atge-no-style-lg" />
...
<?php include('../footer1.php');
 ...
 <!-- <a href="https://home.ctw.utwente.nl/slootenvanf/div/fancybox_images/Chrysanthemum.jpg"><img src="https://home.ctw.utwente.nl/slootenvanf/div/fancybox_images/tn/Chrysanthemum.jpg" alt="Chrysanthemum: nice flower."></a> -->
